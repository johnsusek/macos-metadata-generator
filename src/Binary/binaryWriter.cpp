...
binary::MetaFileOffset binary::BinaryWriter::push_string(const string& str, bool shouldIntern)
{
...
binary::MetaFileOffset binary::BinaryWriter::push_binaryArray(vector<binary::MetaFileOffset>& binaryArray)
{
    binary::MetaFileOffset offset = this->_stream->position();
