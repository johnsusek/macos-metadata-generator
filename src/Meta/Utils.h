...
public:
    ...
    // TODO Susek: move these to a new class like BuildConfiguration or something
    static bool isMacOSBuild;
  static Version buildTarget;
  static Version swiftVersion;
};
}
