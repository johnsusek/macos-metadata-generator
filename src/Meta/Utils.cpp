...
bool areRecordFieldListsEqual(const vector<RecordField>& vector1, const vector<RecordField>& vector2)
{
    if (vector1.size() != vector2.size()) {
        return false;
    }

    for (vector<RecordField>::size_type i = 0; i < vector1.size(); i++) {
...
bool Utils::areTypesEqual(const vector<Type*>& vector1, const vector<Type*>& vector2)
{
    if (vector1.size() != vector2.size()) {
        return false;
    }

    for (vector<Type*>::size_type i = 0; i < vector1.size(); i++) {
